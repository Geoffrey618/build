export default {
  title: 'Iyang-Airlines',
  logo: 'I',
  author: '',
  whiteList: ['/login', '/404', '/401', '/lock'],
  lockPage: '/lock',
  info: {
    title: 'Iyang-Airlines智慧机场管理系统',
    list: [
      'Iyang-Airlines智慧机场管理系统，为您提供宾至如归的用户体验',
      '您可以实现机票购买查询、后台管理、表单报修等各类功能',
      '我们竭诚保障您此次舒适的旅途体验和后台管理体验',
      '技术栈成员：张景轩，蒋康，张之睿，黎耀坤，徐景宣'
    ]
  },
  wel: {
